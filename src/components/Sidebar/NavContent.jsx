...
//Header Icon
import { ReactComponent as SquadHeader } from "../../assets/icons/tester.svg";
      ...
      <Box className="dapp-sidebar-inner" display="flex" justifyContent="space-between" flexDirection="column">
        <div className="dapp-menu-top">
          <Box className="branding-header">
            <Link href="https://traderjoexyz.com" target="_blank">
              <SvgIcon
                color="primary"
                component={SquadHeader}
                viewBox="0 0 180 100"
                style={{ minWdth: "250px", minHeight: "175px", width: "250px" }}
              />
            </Link>
            ...
            <div className="dapp-nav" id="navbarNav">
              {networkId === 1 || networkId === 4 ? (
                <>
                  ...
                  >
                    <Typography variant="h6">
                      <SvgIcon color="primary" component={WhitelistIcon} />
                      <Trans>Presale</Trans>
                    </Typography>
                  </Link>
                  ...
                  <Link
                    href={"https://synapseprotocol.com/?inputCurrency=DAI&outputCurrency=DAI&outputChain=137"}
                    target="_blank"
                  >
                    <Typography variant="h6">
                      <BridgeIcon />
