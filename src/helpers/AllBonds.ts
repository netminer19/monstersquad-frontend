...
import { ReactComponent as OhmEthImg } from "src/assets/tokens/OHM-DAI.svg";
...
export const allBonds = [dai, usdc, cvx, ohm_dai, lusd, ohm_lusd, ohm_weth];
